...
function Herramientas() {
  return (
    <>
      <h2>Herramientas</h2>
      <ul>
        <LiProgress label="Visual Studio Code" value={70} tooltip="Lo use mucho (+5 años), pero tiene muchos ajustes que no me fije tanto..." />
        ...
        <LiProgress label="Unity" value={40} tooltip="Hice un juego :D (1 año de proyecto), se sobre temas generales" />
        <LiProgress label="Unreal Engine" value={20} tooltip="Traté de rehacer el juego aca, leí un poco de la documentación, es mucho. Pienso en seguir con esto en un futuro" />
