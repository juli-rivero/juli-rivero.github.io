  ...
  return (
    <>
      ...
      <ul>
        ...
        <LiProgress label="Python" value={35} tooltip="Lo usé para una página web con Flask y flask-sqlalquemy. Ví tambien sobre manejo de archivos (txt, csv, json y un poco de pdf)"/>
        ...
        <LiProgress label="Dart" value={70} tooltip="Para saber sobre Flutter es necesario conocer sobre Dart" />
        <LiProgress label="Flutter" value={45} tooltip="Desarrolle un juego y lo publique en Google Play Store" />
